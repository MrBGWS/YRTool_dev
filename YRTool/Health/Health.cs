...
namespace YRTool
{
	...
	/// <summary>
	/// 这个类管理对象的健康状况，引导其潜在的健康条，处理它受到伤害时发生的事情
	...
	public class Health : MonoBehaviour
	{
		...
		public virtual void Damage(float damage, GameObject instigator, float flickerDuration, float invincibilityDuration, Vector3 damageDirection, List<TypedDamage> typedDamages = null)
		{
			...
			DamageTakenEvent.Trigger(this, instigator, CurrentHealth, damage, previousHealth);
	...
	public struct DamageTakenEvent
	{
		...
		public DamageTakenEvent(Health affectedHealth, GameObject instigator, float currentHealth, float damageCaused, float previousHealth)
		{
			AffectedHealth = affectedHealth;
